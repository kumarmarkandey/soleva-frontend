...
`)+`
`+g);const O=F+y+h,D=F+g+d,k=r0(l,l.VERTEX_SHADER,O),G=r0(l,l.FRAGMENT_SHADER,D);l.attachShader(R,k),l.attachShader(R,G),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function U(B){if(o.debug.checkShaderErrors){const ut=l.getProgramInfoLog(R)||"",ot=l.getShaderInfoLog(k)||"",ht=l.getShaderInfoLog(G)||"",mt=ut.trim(),z=ot.trim(),K=ht.trim();let Z=!0,St=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(Z=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,R,k,G);else{const Tt=l0(l,k,"vertex"),N=l0(l,G,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
